...
export default function WelcomeDialog({ open, onClose }: WelcomeDialogProps) {
  ...
  return (
    ...
    >
      <div className="bg-toolbar text-toolbar-foreground rounded-xl p-4 shadow-2xl max-w-sm w-full mx-4 animate-fade-in border border-toolbar-border flex flex-col items-center gap-2">
        ...
        <div className="flex items-center gap-2 font-semibold">
          ...
          <h2 id="welcome-dialog-title" className="text-base font-semibold leading-none">
            Arte Bricks 2D
          </h2>
        </div>
        <div className="text-sm text-toolbar-muted">Creado por Jesus Linares</div>
        <a
          href="https://instagram.com/pixcool_ve"
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-1.5 text-sm text-toolbar-foreground hover:opacity-80 transition-opacity"
        >
          <span
